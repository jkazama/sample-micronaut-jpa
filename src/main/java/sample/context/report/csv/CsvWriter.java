...
public class CsvWriter {
    ...
    public void write(final CsvWrite logic) {
        ...
        try {
            out = fromFile() ? new FileOutputStream(file, false) : this.out;
    ...
    public static class CsvStream {
        ...
        private String escape(String s) {
            ...
            if ((!s.contains(String.valueOf(delim)) || !s.contains(String.valueOf(quote)))
                    && !s.contains(String.valueOf(eol))) {
                return quoteStr + s + quoteStr;
            } else {
                return quoteStr + s.replaceAll(quoteStr, quoteStr + quoteStr) + quoteStr;
            }
        }
    }
